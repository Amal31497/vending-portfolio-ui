...
function OurMachines() {
    ...
    return (
        <div className="our-machines-wrapper row">
            <div className="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12"></div>
            <div className="our-machines-info col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <p id="our-machines-main-text">
                    Choose a vending machine that fits your organization or
                    building and suits your standards. Our machine selection
                    consists of snack, drink and combo machines. We monitor
                    placed machines and act promptly to restock them in a
                    timely manner. Every machine is equipped with electronic
                    card reader as well as cash payment processor.
                </p>
